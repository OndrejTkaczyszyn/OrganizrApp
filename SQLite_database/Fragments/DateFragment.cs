...
namespace FragmentExample
{
    public class DateFragment : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.fragment_3, container, false);//end potentially true
        ...
        public void endMyMisery(View view)
        {
            ...
            var viewToShow = this.Activity.FindViewById<LinearLayout>(Resource.Id.UserControls);
